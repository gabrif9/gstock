...
const Expenses = () => {
    ...
    const classNames = {
        ...
        selectInput: "mt-1 block w-full pl-3 pr-10 pt-2 pb-2 text-base border-gray-300 focus:ring-indico-500 focus:border-indigo-500 sm:text-sm rounded-md"
    }
        ...
        <div>
            ...
            <div className="mb-5">
                ...
                <p className="text-sm text-gray-500">
                    A visual represantation of expenses over time.
                </p>
            </div>
